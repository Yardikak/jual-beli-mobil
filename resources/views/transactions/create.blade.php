<x-layouts.app>
    <div class="max-w-3xl mx-auto py-10 px-4">
        <h1 class="text-white text-2xl font-bold mb-6">Tambah Transaksi</h1>
        ...
        <form action="{{ route('transactions.store') }}" method="POST" class="bg-white shadow p-6 rounded">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="total_price" id="total_price" value="{{ old('total_price') }}" class="w-full border rounded px-3 py-2" required>
            </div>
