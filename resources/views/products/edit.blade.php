<x-layouts.app>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('products.update', $product->id) }}" class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="4" 
                    class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" 
                    placeholder="Contoh: Mobil keluarga dengan kapasitas 7 penumpang" required>{{ $product->description }}</textarea>
            </div>
